      ...
      <div className='container'>
        <div className='flex justify-end gap-4'>
          <Popover
            ...
            renderPopover={
              <div className='boder-gray-200 relative rounded-sm border bg-white shadow-md'>
                <div className='flex flex-col px-3 py-2 pr-32'>
        ...
        <div className='mt-4 grid grid-cols-12 items-end gap-4'>
          ...
          <div className='col-span-1 justify-self-center'>
            <Popover
              ...
              renderPopover={
                <div className='boder-gray-200 relative max-w-[400px] rounded-sm border bg-white text-sm shadow-md'>
                  <div className='p-2'>
                    ...
                    <div className='mt-5'>
                      <div className='mt-4 flex'>
                        ...
                        <div className='ml-2 flex-shrink-0'>
                          <span className='text-orange'>đ460.000</span>
                        </div>
                      </div>
                      <div className='mt-4 flex'>
                        <div className='flex-shrink-0'>
